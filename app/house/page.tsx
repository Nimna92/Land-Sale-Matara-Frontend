...
export default function HousePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex space-x-8 items-center">
              ...
              <Link href="/house" className="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition">Houses</Link>
      ...
      {/* Header Section with Gradient - House Page */}
      <header className="bg-gradient-to-r from-amber-700 to-amber-900 text-white py-16 px-6 mb-8">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-5xl font-bold mb-4">{t('house.heading')}</h1>
          <p className="text-lg text-amber-100 max-w-2xl">{t('house.subheading')}</p>
        </div>
      </header>
      ...
      <div className="max-w-7xl mx-auto px-6 pb-20">
        ...
        <div className="mb-6 text-gray-600 font-medium">
          {t('house.showing', { count: houseAds.length })}
        </div>
